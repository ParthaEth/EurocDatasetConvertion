...
null_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, null_marginalized_vertices, 20);
...
RCKLAM_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, RCKLAM_marginalized_vertices, 100);
...
CKLAM_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, CKLAM_marginalized_vertices, 160);
...
optvi_fullmap_vertices = ...
    alignOverall(ground_truth_vertices, optvi_fullmap_vertices, 600);
