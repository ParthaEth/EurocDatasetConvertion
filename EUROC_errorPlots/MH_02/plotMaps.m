...
optvi_fullmap_vertices = ...
    alignOverall(ground_truth_vertices, optvi_fullmap_vertices, 700);
...
null_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, null_marginalized_vertices, 37);
...
RCKLAM_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, RCKLAM_marginalized_vertices, 130);
...
fclose(raw_fullmap);
raw_vertices = ...
    alignOverall(ground_truth_vertices, raw_vertices, 100);
