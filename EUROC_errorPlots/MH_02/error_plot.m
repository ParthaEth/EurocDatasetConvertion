...
ground_truth_fullmap = fopen('MH_02/true_vertex_id_to_position.csv');
ground_truth_vertices = textscan(ground_truth_fullmap,...
    '%s %f %f %f', 'Delimiter',',');
fclose(ground_truth_fullmap);

% Full map raw odometry vs optvi
optivi_nolc_fullmap = fopen('MH_02/vertices_optvi.csv');
...
% raw odometry plot
raw_fullmap = fopen('MH_02/vertices_raw_odometry.csv');
...
null_marginalized_map = fopen('MH_02/vertices_kfh_optvi.csv');
...
CKLAM_marginalized_map = fopen('MH_02/vertices_cklam.csv');
...
RCKLAM_marginalized_map = fopen('MH_02/vertices_rcklam.csv');
