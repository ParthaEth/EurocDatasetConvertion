...
% raw odometry plot
raw_fullmap = fopen('MH_01/vertices_raw_odometry.csv');
...
CKLAM_marginalized_map = fopen('MH_01/vertices_cklam.csv');
...
RCKLAM_marginalized_map = fopen('MH_01/vertices_rcklam.csv');
