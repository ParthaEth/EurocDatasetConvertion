...
path = ['./EUROC_errorPlots/',mapname,'/',mapname];
...
fclose(raw_fullmap);
raw_vertices = ...
    alignOverall(ground_truth_vertices, raw_vertices, 500);
...
null_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, null_marginalized_vertices, 122);
...
RCKLAM_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, RCKLAM_marginalized_vertices, 200);
...
CKLAM_marginalized_vertices = ...
    alignOverall(ground_truth_vertices, CKLAM_marginalized_vertices, 122);
...
optvi_fullmap_vertices = ...
    alignOverall(ground_truth_vertices, optvi_fullmap_vertices, 500);
